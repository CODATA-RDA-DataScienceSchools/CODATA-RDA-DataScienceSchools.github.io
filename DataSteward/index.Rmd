...
The provisional detailed programme can be found [here](./DataTrieste2019Programme/Timetable.html) with a breakdown of the shared and separate courses.
...
*This document was created on `r format(Sys.time(),"%a %b %d %Y")`*